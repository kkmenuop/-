...
frame.Size = UDim2.new(0, 150, 0, 80) -- Adjusted size to fit the new text
...
fpsLabel.Size = UDim2.new(0.8, 0, 0.2, 0)
...
pingLabel.Position = UDim2.new(0.1, 0, 0.4, 0)
pingLabel.Size = UDim2.new(0.8, 0, 0.2, 0)
...
-- Public Build Label
local publicBuildLabel = Instance.new("TextLabel")
publicBuildLabel.Parent = frame
publicBuildLabel.BackgroundTransparency = 1
publicBuildLabel.Position = UDim2.new(0.1, 0, 0.7, 0)
publicBuildLabel.Size = UDim2.new(0.8, 0, 0.2, 0)
publicBuildLabel.Font = Enum.Font.JosefinSans
publicBuildLabel.Text = "Public build 🟢"
publicBuildLabel.TextColor3 = Color3.fromRGB(0, 255, 0) -- Bright green text
publicBuildLabel.TextSize = 14
publicBuildLabel.TextXAlignment = Enum.TextXAlignment.Left
...
-- Popup Notification for Script Loaded
local function createPopup(message)
    ...
    popupFrame.Position = UDim2.new(0.5, -100, 0.5, -25) -- Center of the screen
    popupFrame.Size = UDim2.new(0, 200, 0, 50)
    ...
    popupLabel.Font = Enum.Font.JosefinSans
    ...
    -- Fade out animation
    TweenService:Create(popupFrame, TweenInfo.new(1, Enum.EasingStyle.Linear), {
...
-- Show "Script Loaded" notification when the script starts
createPopup("Script Loaded")
...
-- Welcome Message with Roblox Username
...
WelcomeLabel.Text = "Welcome " .. LocalPlayer.Name -- This adds the username
...
wait(0.5)
local welcomeFade = ts:Create(WelcomeLabel, TweenInfo.new(1), {TextTransparency = 0})
welcomeFade:Play()
...
quotasname.Text = "Kakah Menu Legit"
...
SilentAim.Image = "http://www.roblox.com/asset/?id=1264515756"
...
SpeedHack.Image = "http://www.roblox.com/asset/?id=1264515756"
...
InfAmmo.Image = "http://www.roblox.com/asset/?id=1264515756"
...
FFSpeed.Image = "http://www.roblox.com/asset/?id=1264515756"
...
Recoil.Image = "http://www.roblox.com/asset/?id=1264515756"

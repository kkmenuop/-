...
pfp = userinfo["pfp"] or "http://www.roblox.com/asset/?id=17151235079" .. game.Players.LocalPlayer.UserId .. "&width=420&height=420&format=png"
...
local function RippleEffect(object)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "http://www.roblox.com/asset/?id=17151235079"
...
function DiscordLib:Window(text,mainclr,cls)
	local PresetColor = mainclr or Color3.fromRGB(0, 3, 203) or _G.Color
	...
	Glow.ZIndex = 2
	Glow.Image = "http://www.roblox.com/asset/?id=17151235079"
	...
	UserCircleImage.Image = "http://www.roblox.com/asset/?id=17151235079"
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text,ico)
            ...
            function ChannelContent:Toggle(text, default, callback)
                ...
                Icon.Image = "http://www.roblox.com/asset/?id=17151235079"
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				ArrowImg.Image = "http://www.roblox.com/asset/?id=17151235079"
			...
			function ChannelContent:Colorpicker(text, preset, callback)
				...
				ColorSelection.Image = "http://www.roblox.com/asset/?id=17151235079"
...
ImageButton.BackgroundColor3 = Color3.fromRGB(0, 14, 203)
ImageButton.Position = UDim2.new(0.10615778, 0, 0.16217947, 0)
ImageButton.Size = UDim2.new(0.0627121851, 0, 0.107579626, 0)
ImageButton.Image = "http://www.roblox.com/asset/?id=17151235079"
...
local serv = win:Server("Kakah Menu V8","")

local AutoFarm = serv:Channel("Início", "http://www.roblox.com/asset/?id=7040391851")

Time = AutoFarm:Label("Tempo de Servidor")
...
function UpdateTime()
    ...
    Time:Refresh("Horas : "..Hour.." Minutos : "..Minute.." Secondos : "..Second)
end
...
function UpdateClient()
    local Ping = game:GetService("Status").Network.ServerStatsItem["Data Ping"]:GetValueString()
...
AutoFarm:Button("TP Não esqueça de Clicar",function()
	BTP(CFrameMon)
end)



AutoFarm:Toggle("Farm Level", _G.AutoFarmLevel, function(vu)
    _G.AutoFarm = vu
	if _G.AutoFarm and SelectToolWeapon == "" then
		DiscordLib:Notification("AutoFarm","SelecioneWeapon Primeiro","Okay")
	else
		Auto_Farm = vu
		SelectMonster = ""
		if vu == false then
...
------------------------------
	AutoFarm:Button("TP Ilha Katakuri",function()
		BTP(CFrame.new(-1820.0634765625, 210.74781799316406, -12297.49609375))
	end)

AutoFarm:Toggle("Farm katakuri",false,function(value)
...
AutoFarm:Toggle("Definir Respawn Point", false, function(vu)
    AutoSetSpawn = vu
end)

if New_World then
    AutoFarm:Toggle("Farm Factory", false, function(vu)
        Factory = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
if Three_World then
	AutoFarm:Toggle("Farm Boss Aleatório", _G.AutoElite, function(vu)
		EliteHunter = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
	...
	AutoFarm:Toggle("Pegue a espada Yama	", _G.AutoYama, function(vu)
		AutoYama = vu
	end)
	AutoFarm:Toggle("Pegue Haki Rainbow", false, function(vu)
		AutoRainbow = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
if Old_World then
	AutoFarm:Toggle("TP Sea2", _G.AutoNewworld, function(vu)
		Auto_Newworld = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
if New_World then
	AutoFarm:Toggle("TP sea3", _G.AutoThirdSea, function(vu)
        ReadyThirdSea = vu
		TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
AutoFarm:Toggle("Obtenha superhuman", _G.AutoSuperhuman, function(vu)
    Superhuman = vu
end)

AutoFarm:Toggle("Obtenha Superhuman (tất cả)", _G.FullyAutoSuperhuman, function(vu)
    AutoFullySuperhuman = vu
end)

AutoFarm:Toggle("Obtenha Electric Claw", false, function(vu)
    AutoElectricClaw = vu
...
--rough sea
AutoFarm:Label("Evento Marine")

AutoFarm:Toggle("Farm Terrorshark",false,function(vu)
	_G.AutoTerrorshark = vu
end)

AutoFarm:Toggle("Farm Piranha",false,function(vu)
    _G.farmpiranya = vu
end)

AutoFarm:Toggle("Farm Shark",false,function(vu)
    FarmShark = vu
end)

AutoFarm:Toggle("Farm FishCrew",false,function(vu)
...
AutoFarm:Toggle("Tp Ilha KItsune",false,function(vu)
	_G.AutoFKitsune = vu
end)

AutoFarm:Toggle("Pegue a Pedra do Fogo",false,function(vu)
...
local SelectWeapon = AutoFarm:Dropdown("Selecione o Weapon",Wapon,function(Value)
...
if New_World then
    AutoFarm:Toggle("Compre legendary swords	", _G.Auto_Legendary_Sword, function(Value)
        LegebdarySword = Value    
    end)
end
if not Old_World then
    AutoFarm:Toggle("Compre color haki", _G.AutoEnchancement, function(Value)
        Enchancement = Value    
    end)
end
...
AutoFarm:Toggle("Farm com proficiência à esquerda", false, function(vu)
...
AutoFarm:Toggle("Farm proficiente com armas", false, function(vu)
...
HealthPersen = 25
AutoFarm:Slider("Sangue %", 1,100,HealthPersen, function(Value)
	HealthPersen = Value
end)

AutoFarm:Toggle("Reúna monstros com habilidade", false, function(vu)
	MasteryMagnet = vu
end)

local SelectWeapon = AutoFarm:Dropdown("Escolha a Arma",Wapon,function(Value)
    WeaponMastery = Value
end)
...
elseif Three_World then
    ...
    AutoFarm:Toggle("Luta Boss",_G.AutoFarmBoss,function(value)
...
AutoFarm:Dropdown("Escolha o Monstro", tableMon, function(vu)
	SelectMonster = vu
end)

AutoFarm:Toggle("Farm Monstro", false, function(vu)
...
if New_World then
	AutoFarm:Toggle("Trabalhar como Nv Bartilo", false, function(vu)
		CheckBarto = vu
	...
	AutoFarm:Toggle("Aumentando a Tribo V2", false, function(vu)
		CheckEvo = vu
	...
	AutoFarm:Toggle("Pegue a espada Rengoku", false, function(vu)
		AutoRengoku = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
	...
	AutoFarm:Toggle("Farm Matéria Estranha", false, function(vu)
		AutoEcto = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
if Three_World then
	AutoFarm:Toggle("Torna-se um Cidadão", false, function(vu)
		CheckCitizen = vu
		TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
AutoFarm:Button("TP Ilha Bone",function()
...
local Bone = AutoFarm:Label("Farm Bone")

spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		Bone:Refresh("Número de Bones : "..tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
	end
end)


AutoFarm:Toggle("Mudar Bones", false, function(vu)
	AutoBuySurprise = vu
end)
...
if Three_World then
    ...
    AutoFarm:Toggle("Tente a sua Sorte [gravestone]", false, function(vu)
        TryLuck = vu
    end)

    AutoFarm:Toggle("Rezar [gravestone]", false, function(vu)
        Pray = vu
    end)

    AutoFarm:Toggle("Farm Bone", false, function(vu)
		Auto_Bone = vu
		if vu == false then
			wait(1)
			TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
...
AutoFarm:Toggle("Farm Point Haki Observation", AutoFarmKen, function(vu)
...
Tp:Toggle("Ctrl + click = tp (Computador)", false, function(vu)
	CTRL = vu
end)

Tp:Button("Pare Fly", function()
    Clip = false
    TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
end)
...
if Old_World then
    ...
    Tp:Button("Sea2", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)

	Tp:Button("Sea3", function()
...
local Players = serv:Channel("Player","http://www.roblox.com/asset/?id=7252023075")
...
Player = ""
local SelectPlayer = Players:Dropdown("Selecione Player", PlayerName, function(vu)
...
Players:Toggle("Espectrar", false, function(vu)
    Spectate = vu
...
Players:Toggle("Hit Player", _G.AutoBounty, function()
	_G.AutoBounty = vu
end)
...
local SelectWeapon = Players:Dropdown("Selecione o Weapon",Wapon,function(Value)
...
Players:Toggle("Kill players", false, function(vu)
    KillPlayer = vu
	TP(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
end)

Players:Toggle("Observe o movimento da arma", false, function(vu)
	Aimbot = vu
end)

Players:Toggle("Observe os movimentos das pessoas próximas", false, function(vu)
	AimSkillNearest = vu
end)
...
local Raid = serv:Channel("Esp e Raid","http://www.roblox.com/asset/?id=7251993295")
if New_World then
	Raid:Button("TP Ilha Comprar Chips Raid", function()
...
Raid:Toggle("Kill Monsters", false, function(vu)
    Killaura = vu
end)

Raid:Toggle("Upgrade v2", false, function(vu)
    AutoAwakener = vu
end)

Raid:Toggle("Pela Ilha", false, function(vu)
    NextIsland = vu
end)

Raid:Line()

Raid:Toggle("Auto Attack", false, function(vu)
    _G.AutoRaid = vu
end)

Raid:Dropdown("Selecione Raid", {"Flame","Ice","Quake","Light","Dark","Spider","Rumble","Magma","Buddha","Dough","Phoenix"}, function(vu)
    _G.SelectRaid = vu
end)

Raid:Toggle("Compre chip", false, function(vu)
    AutoBuychip = vu
end)
...
Raid:Toggle("Lute contra Boss Law", false, function(vu)
	AutoLowRaid = vu
end)

Raid:Toggle("Compre chip boss law", false, function(vu)
	AutoBuyChiplawraid = vu
end)

local SelectWeaponLaw = Raid:Dropdown("Selecione Weapon",Wapon,function(vu)
	SelectToolWeaponLaw = vu
end)

Raid:Button("Refresh", function()
...
Raid:Toggle("ESP Báu",false,function(Value)
    ChestESP = Value
...
local Devil = serv:Channel("Devil Fruit","http://www.roblox.com/asset/?id=7044284832")
...
Devil:Toggle("Compre Fruit",false,function(vu)
    BuyFruitSinper = vu
end)
spawn(function()
    while wait(.1) do
...
Devil:Toggle("Loja Frutas", false, function(vu)
	AutoStoreFruit = vu
end)
...
Devil:Toggle("Colete Frutas ", _G.BringFruit, function(value)
	BringFruit = value
end)
...
Devil:Toggle("Drop Left", false, function(vu)
    Drop = vu
end)
...
Devil:Toggle("Change Left", false, function(v)
    DevilAutoBuy = v
end)
...
local BuyItem = serv:Channel("Loja","http://www.roblox.com/asset/?id=7294901968")

BuyItem:Label("Habilidades")
...
BuyItem:Toggle("Compre Estilo Habilidades", false, function(t)
    Abilities = t
...
BuyItem:Button("Retorno de Indice [2500 F]", function()
...
Setting:Toggle("Bata rapidamente",true,function(value)
    FastAttackSpeed = value
end)

Setting:Toggle("Ligar haki", true, function(vu)
    Auto_Haki = vu
end)

Setting:Toggle("Ligar haki Obervation", false, function(vu)
	AutoObservation = vu
end)
...
Y = 20
Setting:Slider("Distancia [Máximo 20]", 0,50,Y, function(vu)
	Y = vu
end)
...
Setting:Slider("Level Lock", 1,2550,_G.LevelMax, function(value)
	LevelLock = value
end)

Setting:Toggle("Level Lock (Kick)", false, function(vu)
	LevelLockKick = vu
end)

Setting:Toggle("Level Lock (Ligar Off Game)", _G.LevelLock, function(vu)
	LevelLockClose = vu
end)

Setting:Toggle("Reuna Monstros", true, function(vu)
    Magnet = vu
end)
...
Setting:Label("Auto-Habilidades Farm")
...
local Misc = serv:Channel("Outros","http://www.roblox.com/asset/?id=7044233235")
...
Misc:Button("Servidor PoucosPlayers", function()
	HopLowerServer()
end)

Misc:Button("Selecionar Servidor", function()
	DiscordLib:Notification("Hop Server", "Wait For Teleport", "Ok")
	Teleport()
end)

Misc:Button("Reentrar no Servidor", function()
	game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").localPlayer)
end)

Misc:Line()

Misc:Button("Entrar nos Piratas", function()
    local args = {
        [1] = "SetTeam",
        [2] = "Pirates"
    }
...
Misc:Button("Entrar nos Marinheiros",function()
    local args = {
        [1] = "SetTeam",
        [2] = "Marines"
    }
...
Misc:Button("Esquerda Loja", function()
    local args = {
        [1] = "GetFruits"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:Button("Tabela Color Haki", function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Misc:Button("Tabela Titles", function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
if New_World then
	Misc:Button("tp para Flowers", function()
...
Misc:Toggle("Navegação ilimitada", false, function(Value)
    nododgecool = Value
    NoDodgeCool()
end)

Misc:Toggle("Energia ilimitada",false,function(value)
    InfinitsEnergy = value
    originalstam = LocalPlayer.Character.Energy.Value
end)

Misc:Toggle("Correr rápido", false, function(vu)
	InfAbility = vu
end)
...
Misc:Toggle("Clique auto", false, function(value)
    AutoClick = value 
end)

Misc:Toggle("Andar na água", true, function(vu)
    _G.Water = vu
end)
...
Misc:Button("Graphics", function()
	BeautifulMode()
end)

Misc:Toggle("Destaque o Jogo", false, function(vu)
	_G.LightMode = vu
end)
...
Misc:Toggle("Fly (Computador)", false, function(vu)
   Fly = vu
   activatefly()
end)

Misc:Toggle("NoClip [Falso]", false, function(vu)
    noclip = vu
end)

Misc:Button("Excluir lava", function()
...
Misc:Button("Selecione os Códigos", function()
...
Misc:Button("Reduzir lag", function()
...
local RaceV4 = serv:Channel("Raça V4", "http://www.roblox.com/asset/?id=7040391851")
    ...
    RaceV4:Button("TP para árvore	",function()
        TP(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
          end)
          
          RaceV4:Button("Tp para a sala de atualização do clã",function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
          end)
          
      RaceV4:Button("TP para a alavanca",function()
        TP(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
      end)
      
      RaceV4:Button("Tp para o Ancião",function()
        ...
        RaceV4:Label("concluir a etapa")
        
        RaceV4:Button("Compre Engrenagens",function(t)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
        end)
        
      RaceV4:Button("Dissipar anjos automaticamente",function(t)
              game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Workspace.Map.SkyTrial.Model.FinishPart.CFrame
              end)
      
              RaceV4:Button("Passe automático de coelho",function(t)
              ...
              RaceV4:Button("Fuga ciborgue automatizada",function(t)
              game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0,300,0)
              end)
       
      
      
          RaceV4:Toggle("Matar pessoas na prisão",false,function(Val)
              _G.AutoKillTial = Val

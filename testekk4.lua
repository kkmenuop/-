...
function game_name()
  local A = "Não é possível encontrar o nome do jogo:)"
...
Drop_2.Image = "http://www.roblox.com/asset/?id=17151235079"
...
Clound.Image = "http://www.roblox.com/asset/?id=17151235079"
...
Drop.Image = "http://www.roblox.com/asset/?id=17151235079"
...
TOTEXT.Text = "Checando Game..."
wait(1)
TOTEXT.Text = game_name()
wait(1)
TOTEXT.Text = "Verificando se o jogo é compatível..."
local sp = false
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=17151235079"
...
if game.PlaceId == 7449423635 or game.PlaceId == 2753915549 or game.PlaceId == 4442272183 then ---// Blox Fruits
	local lib = loadstring(game:HttpGet("https://paste.ee/r/ayCc8"))()

lib:SetTitle("Inicializador | Blox Fruits")

lib:SetIcon("http://www.roblox.com/asset/?id=17151235079")


lib:AddButton("Kakah Menu Blox Fruits V7", function()
    loadstring(game:HttpGet("https://paste.ee/r/VhkLk"))()
end)
end
----------------------------------------------------------------------------------------------------------------------------------------
--[[else
